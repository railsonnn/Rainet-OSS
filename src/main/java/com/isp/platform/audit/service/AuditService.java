...
public class AuditService {
    ...
    @Transactional
    public void recordFailure(String actor, AuditLog.AuditAction action, String resourceType, String resourceId, String errorMessage) {
        AuditLog log = new AuditLog();
        log.setActor(actor);
        log.setAction(action);
        log.setResourceType(resourceType);
        log.setResourceId(resourceId);
        log.setStatus(AuditLog.AuditStatus.FAILURE);
